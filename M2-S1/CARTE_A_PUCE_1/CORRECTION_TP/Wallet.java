/*
If we used eclipse and JCOP plugin, think to add this command in shell for the run:
/set-var -s PKG_0_APP_0_INST_DATA "0102030405060708" @kickoff

OR in the NEW JCOP PLUGIN, simply ADD 0102030405060708 in INSTALL DATA of your config
*/
